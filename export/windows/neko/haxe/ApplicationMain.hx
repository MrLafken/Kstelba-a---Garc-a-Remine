...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Tiaan", "Kstelbana", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Kstelbaña";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Kstelbaña", null, { width: 512, height: 480 });
